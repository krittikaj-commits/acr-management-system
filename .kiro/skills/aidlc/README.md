...
Where `SPECS_DIR`, `STEERING_DIR` are platform-dependent (`.kiro/specs`, `.claude/specs`, etc.) and `WORKFLOW_DIR` is always `.aidlc/workflow`.
...
```
# Setup fixtures
.kiro/specs/my-feature/context.md      ← minimal context
.kiro/specs/my-feature/requirements.md ← 3 user stories
...
# Assert
# → design.md created at .kiro/specs/my-feature/design.md
# → manifest updated with design artifact, currentPhase = "design"
...
.kiro/specs/my-feature/context.md
